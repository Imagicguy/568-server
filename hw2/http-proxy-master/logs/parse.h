...
private:
  ...
  std::string Parse_header() {
    ...
    std::cout << "header is " << res << std::endl;
    return res;
  }
  ...
  std::string Parse_Request() {
    ...
    res += recv_requ;
    res += "\r\n";
    std::cout << "request is " << res << std::endl;
    return res;
  }
...
public:
  ...
  std::string url_send() { return Parse_Url(); }
  std::string req_send() { return Parse_Request(); }
  std::string host_send() { return Parse_Host(); }
  int port_send() { return Parse_Port(); }
  std::string method_send() { return Parse_Method(); }
  std::string header_send() { return Parse_header(); }
};
#endif
